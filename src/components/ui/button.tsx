...
const buttonVariants = cva(
  "inline-flex items-center justify-center disabled:pointer-events-none disabled:opacity-30 duration-200",
  {
    variants: {
      variant: {
        outline: "ring-white ring-1 hover:bg-neutral-700 text-neutral-100",
        filled:
          "bg-neutral-300 text-neutral-800 ring-transparent hover:bg-neutral-400",
        unchecked:
          "ring-1 ring-neutral-300 text-neutral-300 bg-transparent hover:bg-white/10",
      },
      size: {
